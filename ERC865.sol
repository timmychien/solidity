...
contract ERC865Token is ERC865, StandardToken, Ownable {
     ...
     */
     //this 'to' is sending token destination , not delegate address
    function transferPreSigned(
        bytes memory _signature,
        address _to,
        uint256 _value,
        ...
        returns (bool)
    {
      ...
      * @param _nonce uint256 Presigned transaction number.
      */
      //this 'spender' is sending token destination , not delegate address
...
contract SampleERC865Token is ERC865Token {
    ...
    function mint(address to,uint256 amount) onlyMember(to) public{
        totalSupply_=totalSupply_.add(amount);
        balances[to]=balances[to].add(amount);
        emit Transfer(address(0),to,amount);
    }
    function burn(address to,uint256 amount) onlyMember(to) public{
