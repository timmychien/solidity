...
contract CobinhoodToken is StandardToken, Ownable {
    ...
    //only address payable provide transfer function.
    ...
    constructor(CobinhoodToken)public{
    }

    function initialize(address payable _wallet, uint256 _start, uint256 _end,
    ...
    function finalize() onlyOwner public {
        ...
        balances[wallet] = balances[wallet].add(balances[address(0)]);
        balances[address(0)] = 0;
    }

    function saleActive() public payable returns (bool) {
