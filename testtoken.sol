...
contract ERC20Basic is Context, ERC20 {
...
contract ERC20Detailed is ERC20Basic {
...
contract TESTToken is ERC20Basic, ERC20Detailed {
    constructor() public ERC20Detailed("TEST TOKEN", "TEST", 6){
        _mint(msg.sender, 31000000 * 10 ** 18);
    }
}
