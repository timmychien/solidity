...
contract Factory{
    bytes4 internal constant createNFTSig = 0x68613d17;
    constructor()public{
    ...
    function createNFT(string memory  tokenName, string memory tokenSymbol,string memory tokenURI)public returns (address NFT){
    ...
    function getAddress(bytes memory bytecode,string memory  tokenName, string memory tokenSymbol)
        public
        view
        returns (address)
